...
# ============================================================================
# Script: Evaluate DIFFUSION models with TERMINAL OUTPUT
# ============================================================================
...
echo "========================================="
echo "  FID Evaluation - DIFFUSION (Interactive)"
echo "========================================="
...
for dataset in "${ALL_DATASETS[@]}"; do
    ...
    if [[ "$dir_name" == *"mode_diffusion"* ]]; then
        DATASETS+=("$dataset")
    fi
done

if [ ${#DATASETS[@]} -eq 0 ]; then
    echo "Error: No DIFFUSION datasets found"
    exit 1
fi

echo "Found ${#DATASETS[@]} DIFFUSION dataset(s)"
echo ""
