...
CHECKPOINT="/home/tangzihan/cifar10-experiments/runs/cifar10_flow_cfg_0.13_bs_128_lr_0.0003/checkpoints/epoch_100.pt"

# Sampling settings
MODE="flow"          # 'diffusion' or 'flow'
...
for S in "${SCALES[@]}"; do
    ...
    FILENAME="generated_2500x10_mode_flow_steps_30_cfg_scale_${S}.0/gen_cfg_${S}.pkl"
    ...
    LOG_FILE="eval_results/eval_log_2500x10_mode_flow_steps_30_cfg_scale_${S}.0.txt"
...
echo "All datasets and logs are saved"
echo "========================================================"